    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            if best_model_score<0.6:
                raise CustumeException("No best model found")
            ...
            r2_square = r2_score(y_test, predicted)  # Ensure r2_score is calculated
            return r2_square  # Return the calculated r2_score
